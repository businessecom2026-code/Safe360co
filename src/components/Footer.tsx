      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-sm">
              Protegendo o futuro do comércio digital com segurança de ponta a ponta e conformidade simplificada.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Preços</a></li>
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Segurança</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Privacidade</a></li>
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Termos</a></li>
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">LGPD</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 bg-green-50 dark:bg-green-900/20 px-3 py-1 rounded-full border border-green-100 dark:border-green-900/30">
            ...
            <span className="font-medium text-green-700 dark:text-green-400">Em conformidade com GDPR (EU) e LGPD (BR)</span>
          </div>
        </div>
      </div>
    </footer>
